    ...
    <AppBar className="header" position="static">
      <div className="main-menu">
        ...
        <Link href="/" className="button link-button">
          ...
          <span className="desktop-long-label">Nos agences</span>
        </Link>
        <Link href="/" className="button link-button">
        ...
        <Link href="/" className="button link-button">
          <ShoppingBasketOutlinedIcon fontSize="small"></ShoppingBasketOutlinedIcon>
          <span className="desktop-long-label">Mon panier</span>
        </Link>
      </div>
    </AppBar>
  );
